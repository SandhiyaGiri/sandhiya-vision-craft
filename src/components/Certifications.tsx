  ...
  const certifications = [
    {
      ...
      externalLink: "/certificates/Sandhiya_Computer_Vision_NPTEL.pdf",
      icon: Award,
    ...
    },
    {
      ...
      externalLink: "/certificates/Sandhiya_Deep_Learning_NPTEL.pdf",
      icon: Award,
    ...
    },
    {
      ...
      externalLink: "/certificates/iWE League Scholar -  SANDHIYA C V.pdf",
      icon: Award,
